...
Mat Canny_Edge_Detection(Mat img)
{
  ...
  Canny(mat_blur_img, mat_canny_img, 270, 170,3);
...
int main(void)
{
   ...
   //////////////////////////////////////////////////////////////////////////////////////
    ...
    mat_image_org_color = imread("/home/pi/Team_aMAP/Line_Tracer/1/line_1.jpg");
   ...
   while(1)
   {
      ...
      vector<Vec4i> linesP;
      HoughLinesP(mat_image_canny_edge, linesP, 1, CV_PI/180,35,40,100);
